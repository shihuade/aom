...
void av1_cfl_subtract_c(int16_t *pred_buf_q3, int width, int height, int16_t avg_q3);
void av1_cfl_subtract_sse2(int16_t *pred_buf_q3, int width, int height, int16_t avg_q3);
void av1_cfl_subtract_avx2(int16_t *pred_buf_q3, int width, int height, int16_t avg_q3);
RTCD_EXTERN void (*av1_cfl_subtract)(int16_t *pred_buf_q3, int width, int height, int16_t avg_q3);
...
void av1_convolve_2d_sse2(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_q4, const int subpel_y_q4, ConvolveParams *conv_params);
void av1_convolve_2d_avx2(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_q4, const int subpel_y_q4, ConvolveParams *conv_params);
RTCD_EXTERN void (*av1_convolve_2d)(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_q4, const int subpel_y_q4, ConvolveParams *conv_params);
...
void av1_convolve_2d_copy_sse2(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_q4, const int subpel_y_q4, ConvolveParams *conv_params);
...
void av1_convolve_x_sse2(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_q4, const int subpel_y_q4, ConvolveParams *conv_params);
void av1_convolve_x_avx2(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_q4, const int subpel_y_q4, ConvolveParams *conv_params);
RTCD_EXTERN void (*av1_convolve_x)(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_q4, const int subpel_y_q4, ConvolveParams *conv_params);
...
void av1_convolve_y_sse2(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_q4, const int subpel_y_q4, ConvolveParams *conv_params);
void av1_convolve_y_avx2(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_q4, const int subpel_y_q4, ConvolveParams *conv_params);
RTCD_EXTERN void (*av1_convolve_y)(const uint8_t *src, int src_stride, uint8_t *dst, int dst_stride, int w, int h, InterpFilterParams *filter_params_x, InterpFilterParams *filter_params_y, const int subpel_x_q4, const int subpel_y_q4, ConvolveParams *conv_params);
...
void av1_d117_filter_predictor_c(uint8_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint8_t *above, const uint8_t *left);
#define av1_d117_filter_predictor av1_d117_filter_predictor_c

void av1_d153_filter_predictor_c(uint8_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint8_t *above, const uint8_t *left);
#define av1_d153_filter_predictor av1_d153_filter_predictor_c

void av1_dc_filter_predictor_c(uint8_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint8_t *above, const uint8_t *left);
#define av1_dc_filter_predictor av1_dc_filter_predictor_c
...
void av1_get_br_level_counts_sse2(const uint8_t *const levels, const int width, const int height, uint8_t *const level_counts);
#define av1_get_br_level_counts av1_get_br_level_counts_sse2
...
void av1_h_filter_predictor_c(uint8_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint8_t *above, const uint8_t *left);
#define av1_h_filter_predictor av1_h_filter_predictor_c
...
void av1_highbd_d117_filter_predictor_c(uint16_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint16_t *above, const uint16_t *left, int bd);
#define av1_highbd_d117_filter_predictor av1_highbd_d117_filter_predictor_c

void av1_highbd_d153_filter_predictor_c(uint16_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint16_t *above, const uint16_t *left, int bd);
#define av1_highbd_d153_filter_predictor av1_highbd_d153_filter_predictor_c

void av1_highbd_dc_filter_predictor_c(uint16_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint16_t *above, const uint16_t *left, int bd);
#define av1_highbd_dc_filter_predictor av1_highbd_dc_filter_predictor_c

void av1_highbd_fwht4x4_c(const int16_t *input, tran_low_t *output, int stride);
#define av1_highbd_fwht4x4 av1_highbd_fwht4x4_c

void av1_highbd_h_filter_predictor_c(uint16_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint16_t *above, const uint16_t *left, int bd);
#define av1_highbd_h_filter_predictor av1_highbd_h_filter_predictor_c
...
void av1_highbd_paeth_filter_predictor_c(uint16_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint16_t *above, const uint16_t *left, int bd);
#define av1_highbd_paeth_filter_predictor av1_highbd_paeth_filter_predictor_c
...
void av1_highbd_v_filter_predictor_c(uint16_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint16_t *above, const uint16_t *left, int bd);
#define av1_highbd_v_filter_predictor av1_highbd_v_filter_predictor_c
...
void av1_inv_txfm_add_sse2(const tran_low_t *dqcoeff, uint8_t *dst, int stride, const TxfmParam *txfm_param);
#define av1_inv_txfm_add av1_inv_txfm_add_sse2
...
void av1_paeth_filter_predictor_c(uint8_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint8_t *above, const uint8_t *left);
#define av1_paeth_filter_predictor av1_paeth_filter_predictor_c
...
void av1_selfguided_restoration_avx2(const uint8_t *dgd, int width, int height, int stride, int32_t *flt1, int32_t *flt2, int flt_stride, const sgr_params_type *params, int bit_depth, int highbd);
...
void av1_v_filter_predictor_c(uint8_t *dst, ptrdiff_t stride, TX_SIZE tx_size, const uint8_t *above, const uint8_t *left);
#define av1_v_filter_predictor av1_v_filter_predictor_c
...
RTCD_EXTERN cfl_subsample_lbd_fn (*get_subsample_lbd_fn)(int sub_x, int sub_y);
...
static void setup_rtcd_internal(void)
{
    ...
    av1_cfl_subtract = av1_cfl_subtract_sse2;
    if (flags & HAS_AVX2) av1_cfl_subtract = av1_cfl_subtract_avx2;
    ...
    av1_convolve_x = av1_convolve_x_sse2;
    if (flags & HAS_AVX2) av1_convolve_x = av1_convolve_x_avx2;
    av1_convolve_x_sr = av1_convolve_x_sr_sse2;
    if (flags & HAS_AVX2) av1_convolve_x_sr = av1_convolve_x_sr_avx2;
    av1_convolve_y = av1_convolve_y_sse2;
    if (flags & HAS_AVX2) av1_convolve_y = av1_convolve_y_avx2;
    ...
    get_subsample_lbd_fn = get_subsample_lbd_fn_c;
    if (flags & HAS_SSSE3) get_subsample_lbd_fn = get_subsample_lbd_fn_ssse3;
    if (flags & HAS_AVX2) get_subsample_lbd_fn = get_subsample_lbd_fn_avx2;
}
#endif
